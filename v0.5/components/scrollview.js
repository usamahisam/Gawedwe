...
class ScrollView extends Component {
	...
	view(nodeParent) {
		return (`
		    <svg id="feedback-animation-canvas" width="${window.screen.width}" height="${window.screen.height}" opacity=".6">
	...
	render(view) {
		...
		var elCC = view.querySelector(".container");
		elCC.style.overflow = 'auto';
		elCC.style.scrollBehaviour = 'smooth';
		elCC.style.width = '100%';
		elCC.style.height = '100%';
		elCC.style.maxWidth = '100%';
		elCC.style.maxHeight = '100%';
	...
	scrollBarFun(view) {
	    ...
	    scroller = view.querySelector('.container'),
